        ...
        <div className="fixed inset-4 flex items-center justify-end flex-col pointer-events-none select-none">
          ...
          <div className="flex items-center space-x-4 pointer-events-auto">
            {roomID && !shopMode && !buildMode && (
              ...
              //   LOBBY
              // </button><button
              //   className="p-4 rounded-full bg-slate-500 text-white drop-shadow-md cursor-pointer hover:bg-slate-800 transition-colors" onclick="window.location.href='http://localhost:3001/';">
              //     MARKETPLACE
              //   </button></>
